    ...
    >
      <Link to={`/event/${event.id}`}>
        <div className="group card-gradient rounded-xl border border-border p-5 shadow-sport hover:shadow-sport-hover transition-all duration-300 hover:-translate-y-1">
          <div className="flex items-center justify-center h-40 mb-4 bg-transparent overflow-hidden">
            <div className="h-44 w-44 group-hover:scale-110 transition-transform duration-300 pointer-events-none">
